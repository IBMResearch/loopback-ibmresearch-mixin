      ...
      Model[element] = function (...args) {
        ...
        cache.get(key, function (err, cachedResults) {
          ...
          if (!servedFromCache || cacheOptions.reloadAfterReturn) {
            ...
            let lArguments = Array.prototype.slice.call(methodArguments, 0, methodArguments.length - 1);
            ...
            oldMethods[element].apply(these, lArguments);
          }
        });
        return callback.promise;
      };
